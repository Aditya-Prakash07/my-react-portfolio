  ...
  github: (s = 18, c = "currentColor") => (
    <img
      ...
      style={{
        width: s,
        height: s,
        filter: c === "#fff" ? "invert(1)" : "none",
      }}
    />
  ),
  linkedin: (s = 18, c = "currentColor") => (
    <img src={linkedinIcon} alt="LinkedIn" style={{ width: s, height: s }} />
  ),
  leetcode: (s = 18, c = "currentColor") => (
    <img
      src={leetcodeIcon}
      alt="LeetCode"
      style={{
...
// ─── DATA ────────────────────────────────────────────────────────────────────
const RESUME_URL =
  "https://drive.google.com/file/d/1DkU8gFZMLoLcx03GKrwkncJ4CIbpGDOV/view?usp=sharing";
